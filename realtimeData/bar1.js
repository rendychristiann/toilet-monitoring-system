...
async function updateProgressBar() {
  ...
  // Remove duplicate personCount values
  const uniquePersonCount = Array.from(new Set(data.map(item => item.personCount)));

  const totalUsers = uniquePersonCount.length; // Total pengguna toilet
